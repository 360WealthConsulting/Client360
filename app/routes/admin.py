...
from app.services.identity import add_team_membership, assign_record, assign_role, compose_role, invite_user, list_identity_data, set_user_status
...
class UserInvite(BaseModel): email: str; display_name: str; auth_subject: Optional[str] = None
...
class RecordAssignment(BaseModel): user_id: int; entity_type: str; entity_id: int; assignment_type: str; team_id: Optional[int] = None
