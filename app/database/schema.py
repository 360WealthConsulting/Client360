...
from app.database.work_queue_tables import define_work_queue_tables
from app.database.portal_consent_tables import define_portal_consent_tables
...
from app.database.configuration_tables import define_configuration_tables
...
from app.database.integration_tables import define_integration_tables
from app.database.observability_tables import define_observability_tables
...
from app.database.runtime_behavior_tables import define_runtime_behavior_tables
...
runtime_behavior_tables = define_runtime_behavior_tables(metadata)
...
work_queue_tables = define_work_queue_tables(metadata)
portal_consent_tables = define_portal_consent_tables(metadata)
