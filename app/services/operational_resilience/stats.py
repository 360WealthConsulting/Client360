"""In-process Enterprise Operational Resilience counters (Phase D.60).

Low-cardinality aggregates ONLY — never sensitive operational payloads. These back the low-cardinality
