"""In-process Business Continuity counters (Phase D.55).

Low-cardinality aggregates ONLY — never infrastructure payloads, secrets, or client-sensitive data. These
back the low-cardinality analytics metrics (registered in the SINGLE Analytics Registry — no second metrics
store) + internal diagnostics + observability instrumentation.
"""
