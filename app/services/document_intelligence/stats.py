"""In-process Document Intelligence counters (Phase D.50).

Low-cardinality aggregates ONLY — never document contents, file names, client identifiers, or any
client-sensitive text. These back the low-cardinality analytics metrics (registered in the SINGLE Analytics
