"""In-process Security Operations counters (Phase D.54).

Low-cardinality aggregates ONLY — never passwords, secrets, tokens, session IDs, or authentication payloads.
