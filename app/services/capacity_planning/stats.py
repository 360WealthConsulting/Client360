"""In-process Enterprise Capacity Planning counters (Phase D.61).

Low-cardinality aggregates ONLY — never employee details, payroll, HR records, calendar contents, time
entries, or sensitive staffing data. These back the low-cardinality analytics metrics (registered in the
SINGLE Analytics Registry — no second metrics store) + internal diagnostics + observability instrumentation.
"""
