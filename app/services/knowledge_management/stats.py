"""In-process Enterprise Knowledge Management counters (Phase D.62).

Low-cardinality aggregates ONLY — never document contents, confidential procedures, credentials, tokens, or
client-sensitive documentation. These back the low-cardinality analytics metrics (registered in the SINGLE
Analytics Registry — no second metrics store) + internal diagnostics + observability instrumentation.
"""
