"""In-process Enterprise Identity & Access Governance counters (Phase D.65).

Low-cardinality aggregates ONLY — never passwords, secrets, tokens, session IDs, credentials, authentication
payloads, raw identities, privileged-role membership, or user-level permission maps. These back the
