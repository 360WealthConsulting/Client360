"""In-process Data Governance counters (Phase D.52).

Low-cardinality aggregates ONLY — never client-sensitive data, entity payloads, or identifiers. These back
the low-cardinality analytics metrics (registered in the SINGLE Analytics Registry — no second metrics
