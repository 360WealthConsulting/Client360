"""In-process Automation Orchestration counters (Phase D.51).

Low-cardinality aggregates ONLY — never workflow payloads, entity identifiers, or any client-sensitive
automation data. These back the low-cardinality analytics metrics (registered in the SINGLE Analytics
