"""In-process Vendor Management counters (Phase D.56).

Low-cardinality aggregates ONLY — never contract contents, credentials, license keys, secrets, or
procurement payloads. These back the low-cardinality analytics metrics (registered in the SINGLE Analytics
