...
"""
from .email_feed import email_entries
from .portal import (
...
from .portal_feed import portal_entries
...
__all__ = [
    ...
    # Batch 4d unified staff feed adapters — one FeedEntry shape per authoritative store.
    "email_entries", "portal_entries",
]
