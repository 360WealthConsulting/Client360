"""In-process Integration Hub counters (Phase D.53).

Low-cardinality aggregates ONLY — never secrets, tokens, credentials, or client payloads. These back the
