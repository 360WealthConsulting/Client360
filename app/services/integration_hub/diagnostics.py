"""Integration Hub internal diagnostics (Phase D.53) — INTERNAL-ONLY observability of the integration-hub
...
secrets, tokens, credentials, or client payloads — aggregates only.
"""
from __future__ import annotations

from . import gate, registry, stats
from .governance import validate_integration_hub
