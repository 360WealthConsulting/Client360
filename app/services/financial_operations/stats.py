"""In-process Financial Operations counters (Phase D.57).

Low-cardinality aggregates ONLY — never payroll details, tax returns, bank account numbers, payment
credentials, or accounting payloads. These back the low-cardinality analytics metrics (registered in the
