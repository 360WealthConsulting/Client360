...
# schema and refuse CLEARLY. It is not a fallback path and it does not swallow anything - the query
# below is unchanged and still fails loudly on any other error.
