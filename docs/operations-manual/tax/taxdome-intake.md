...
review_cycle: "annual"
next_review: "TBD"
related: ["TAXOPS-SOP-02", "TAXOPS-SOP-03", "TAXOPS-POL-01"]
...
## Related
**Existing operational dependencies:** `TAXOPS-SOP-02` — 1040 Preparation · `TAXOPS-SOP-03` — Business Return Preparation
**Planned (not yet authored):** `TAXOPS-POL-01` (Tax Documentation Policy) · CHK-014 (1040 Intake Checklist)
...
**External (referenced, not owned):** TaxDome (portal / documents / workflow — externally owned); IRS & applicable state tax authorities.
**Software facet (Client360 — distinct):** `docs/EPIC_5_TAX_PRACTICE_PLATFORM.md` (Client360 Tax platform — distinct)
