...
FIRM_CAPS = frozenset({
    ...
    "communications.read", "communications.view", "compliance.supervise", "record.read_all",
    "observability.audit",
})
...
def test_registry_has_sixteen_sections_with_builders():
    assert len(SECTIONS) == 16  # +Communications (D.44) +Knowledge (D.45) +Recommendations (D.46) +Compliance Oversight (D.47)
