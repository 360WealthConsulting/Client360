...
def test_dashboard_and_widget_registries_complete():
    assert len(registry.DASHBOARD_REGISTRY) == 25  # +D.49..D.65 (…/enterprise_platform_environment_landscape/enterprise_identity_access_governance), all reuse existing widgets
