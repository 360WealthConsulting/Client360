...
def test_dashboard_and_widget_registries_complete():
    assert len(registry.DASHBOARD_REGISTRY) == 23  # +D.49..D.63 (…/enterprise_knowledge_documentation/enterprise_change_release_governance), all reuse existing widgets
