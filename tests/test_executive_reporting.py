...
def test_dashboard_and_widget_registries_complete():
    assert len(registry.DASHBOARD_REGISTRY) == 24  # +D.49..D.64 (…/enterprise_change_release_governance/enterprise_platform_environment_landscape), all reuse existing widgets
